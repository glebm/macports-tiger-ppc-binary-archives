# MacPort binary archives for Tiger PPC (experimental)
...
urls                https://glebm.github.io/macports-tiger-ppc-binary-archives/dist/
```

Then, download the key from <https://glebm.github.io/macports-tiger-ppc-binary-archives/dist/pubkey.pem> to
...
[Package list](https://glebm.github.io/macports-tiger-ppc-binary-archives/dist/)
